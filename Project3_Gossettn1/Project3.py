...
test.add(Node(3))
print("Printing the list and it's size(): ",test, test.size())
...
print(test, "--should be [None]")
print("Adding two 4s and running palindrome check..")
test.add(Node(4))
test.add(Node(4))
print("Is ",test," a palindrome? ",test.is_palindrome())
...
print("From index 1 to 3: ",test.slice(1,3))
